...
map.getView().fit([-11334133.627526, 6240633.262530, -10706342.329215, 6781437.366983], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">National Grasslands of Canada</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (53 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Digital AgroEcosystems Lab.ca<br /><br />University of Manitoba';
            }
